...
public class Exercise_06 {
    ...
    public static void main(String[] args){
        ...
        //  Only need to go through the first half of the array as we're swapping first and last values so dividing
        //  by 2 reduces the number of times the for-loop has to loop
